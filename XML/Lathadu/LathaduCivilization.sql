...
--		PortraitIndex,	IconAtlas,						AlphaIconAtlas,
		0,				'LATHADU_COLOR_ATLAS',			'LATHADU_ALPHA_ATLAS',
--		MapImage,										DawnOfManQuote, 
...
VALUES
	...
	('TXT_KEY_CIV_LATHADU_SHORT_DESC',			'Lathadu'),
...
VALUES	('COLOR_PLAYER_LATHADU_BACKGROUND',			0.965, 0.565, 0.110, 1.0),
		('COLOR_PLAYER_LATHADU_ICON',				0.161, 0.404, 0.278, 1.0);
